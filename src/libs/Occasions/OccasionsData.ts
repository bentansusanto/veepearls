...
export const anniversaryData: Anniversary = {
  ...
  body: "Traditionally, pearls and pearl jewelry are the perfect gift for her wedding anniversary. They’ve also become popular gifts over the years for the 3rd and 12th anniversaries as well.",
  image: "bg-occasion-anniversary.jpg",
  details: [
    {
    ...
    {
      heading: "Pearl Jewelry Gift Ideas for Any Anniversary Year",
      description: [
...
export const birthdayData: Birthday = {
    ...
    body: "Whether she’s your daughter, sister, friend, mother, girlfriend or wife, you want her birthday gift to express your eternal love for her. Yes, most women still love the traditional birthday gifts perfume, chocolates, red roses, wine, candles And, although those gifts will make her smile, they’re just not memorable. You want this year’s birthday gift to stand out above the rest. Pearls and pearl jewelry are not only precious, they will still have luster and value for years to come. Plus, these gems are downright gorgeous!",
    ...
    details: [
        ...
        },
        {
            ...
            description: [
                "Over the last handful of years, jewelry trends have evolved to include various stones in pearls bracelets. Whether the metals are yellow gold, white gold, sterling silver or platinum, adding some gemstones to the makes your bracelets much more eye-catching.",
                "You can use pearls to create tennis bracelet style jewelry. Or, create a bracelet that alters pearls and diamonds, or pearls and her birthstones or stones featuring her favorite colors. For an even more unique look, add charms to her pearl bracelets that symbolize your love for her, her alma mater, her profession, her lifestyle or anything else you can imagine.",
            ],
...
export const holidaysData:Holidays = {
    heading: "How to Choose Jewelry to Wear for the Holidays",
    ...
    image: "bg-occasions-holidays.jpg",
    steps: [
        {
            ...
            description: [
                ...
                "Instead, go with jewelry pieces you really like. Do you typically like wearing lots of jewelry pieces or layered necklaces? Long strands of pearls layer perfectly to make beautiful necklaces for the holidays. They can also be used to create your own multilayered bracelets. Or, you can go with pearl bracelets instead.",
            ],
            image: "bg-occasions-holiday-detail1.jpg"
        },
        {
            name_steps: "2. The Occasion Matters",
            description: [
                "“The holidays” brings with it numerous parties and celebrations. When choosing the type of holiday jewelry to wear, consider the actual occasion.",
                "Just because the jewelry has a Christmas theme, doesn’t necessarily make it appropriate for your specific event. For example, if you’re going to a very dressy office party, you may not want to wear flashy, gaudy Christmas brooches and buttons.",
            ],
            image: "bg-occasions-holiday-detail2.jpg"
        },
        {
            name_steps: "3. Less is Always More",
            description: [
                "This is an idea to keep in mind when shopping for holiday jewelry. If you get too carried away, you may find yourself looking like Cupid, St. Patrick himself or a Christmas tree.",
                "So, always remember less is more. Keep in mind that holiday accessories can be really flashy and colorful. So, choose jewelry pieces for the holidays that stand out. But, don’t choose multiple pieces that make your appearance seem cluttered.",
            ],
            image: "bg-occasions-holiday-detail3.jpg"
        },
        {
            ...
            description: [
                ...
                "Choose one color for your holiday jewelry that unifies your look. For Halloween, for example, you can add multiple pieces of pearl jewelry in shades of orange. For Easter, you can go with pink pearl jewelry, and for Christmas, pearl jewelry in red and green.",
            ],
            image: "bg-occasions-holiday-detail4.jpg"
        },
        {
            name_steps: "5. Keep Your Outfit Simple",
            description: [
                "The best way to show off your festive holiday jewelry pieces is by making sure the rest of your outfit is simple. For example, maybe you want to show off your new Thanksgiving pin, with its bronze color and holiday theme. Pair this up with a plain colored dress that makes the bronze stand out.",
                "You can pick out gear that highlights one of the festive colors in the holiday pin or other accessories. Or, you can keep things simple by wearing white or black. This allows your outfit to act as a blank canvas, which will really highlight your holiday accessory or jewelry.",
            ],
            image: "bg-occasions-holiday-detail5.jpg"
        },
    ]
}
